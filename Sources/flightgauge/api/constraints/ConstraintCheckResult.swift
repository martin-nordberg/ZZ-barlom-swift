...
///
public enum EConstraintCheckResult {
    ...
    case ConstraintCheckComposite( message:String, checks:[EConstraintCheckResult] )
        ...
        get {
            switch self {
                case .ConstraintCheckSuccess( _ ):
                    return 0
                case let .ConstraintCheckComposite( _, checks ):
                    return checks.reduce( 0, combine: { (count:Int,constraint: EConstraintCheckResult ) -> Int in count + constraint.failureCount } )
                default:
                    return 1
            }
        }
        ...
        get {
            switch self {
                case .ConstraintCheckSuccess( _ ):
                    return 1
                case let .ConstraintCheckComposite( _, checks ):
                    return checks.reduce( 0, combine: { (count:Int,constraint: EConstraintCheckResult ) -> Int in count + constraint.successCount } )
                default:
                    return 0
            }
        }
